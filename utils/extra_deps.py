...
# Windows: ~\AppData\Local\stack_composed\python<xy>
# macOS: ~/Library/Application Support/stack_composed/python<xy>
# Linux: ~/.local/share/stack_composed/python<xy>
...
INSTALL_PREFIX = os.path.join(DATA_HOME, 'stack_composed', 'python' + ''.join(PY_MAJORMINOR))
